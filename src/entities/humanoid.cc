...
Game::Utils::Vec2 Game::Entities::Humanoid::Coords() const { return coords; }

int Game::Entities::Humanoid::X() const { return coords.x; }

int Game::Entities::Humanoid::Y() const { return coords.y; }
